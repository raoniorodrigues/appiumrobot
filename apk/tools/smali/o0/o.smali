...
.method private j(Lm0/d;Ljava/util/ArrayList;I)I
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1, p1, v0}, Ln0/e;->g(Lm0/d;Z)V
    ...
    iget v2, v1, Ln0/f;->N0:I

    if-lez v2, :cond_1

    invoke-static {v1, p1, p2, v0}, Ln0/b;->b(Ln0/f;Lm0/d;Ljava/util/ArrayList;I)V
    ...
    iget v3, v1, Ln0/f;->O0:I

    if-lez v3, :cond_2

    invoke-static {v1, p1, p2, v2}, Ln0/b;->b(Ln0/f;Lm0/d;Ljava/util/ArrayList;I)V

    :cond_2
    :try_start_0
    invoke-virtual {p1}, Lm0/d;->z()V
    :try_end_0
    ...
    invoke-direct {v3, p0, v2, p1, p3}, Lo0/o$a;-><init>(Lo0/o;Ln0/e;Lm0/d;I)V
    ...
    iget-object p2, v1, Ln0/e;->H:Ln0/d;

    invoke-virtual {p1, p2}, Lm0/d;->x(Ljava/lang/Object;)I

    move-result p2

    iget-object p3, v1, Ln0/e;->J:Ln0/d;

    :goto_3
    invoke-virtual {p1, p3}, Lm0/d;->x(Ljava/lang/Object;)I
    ...
    :cond_4
    iget-object p2, v1, Ln0/e;->I:Ln0/d;

    invoke-virtual {p1, p2}, Lm0/d;->x(Ljava/lang/Object;)I

    move-result p2

    iget-object p3, v1, Ln0/e;->K:Ln0/d;
...
.method public f(Lm0/d;I)I
    ...
    invoke-direct {p0, p1, v0, p2}, Lo0/o;->j(Lm0/d;Ljava/util/ArrayList;I)I
