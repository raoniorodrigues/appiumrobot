...
.method private i(Landroid/view/MenuItem;)V
    ...
    :cond_8
    :goto_3
    iget-object v0, p0, Lj/g$b;->A:La1/b;

    if-eqz v0, :cond_9

    invoke-static {p1, v0}, La1/h;->a(Landroid/view/MenuItem;La1/b;)Landroid/view/MenuItem;

    :cond_9
    iget-object v0, p0, Lj/g$b;->B:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, La1/h;->c(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lj/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, La1/h;->g(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Lj/g$b;->n:C

    iget v1, p0, Lj/g$b;->o:I

    invoke-static {p1, v0, v1}, La1/h;->b(Landroid/view/MenuItem;CI)V

    iget-char v0, p0, Lj/g$b;->p:C

    iget v1, p0, Lj/g$b;->q:I

    invoke-static {p1, v0, v1}, La1/h;->f(Landroid/view/MenuItem;CI)V

    iget-object v0, p0, Lj/g$b;->E:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_a

    invoke-static {p1, v0}, La1/h;->e(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, La1/h;->d(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
...
.method public g(Landroid/util/AttributeSet;)V
    ...
    invoke-static {v0, p1, v1}, Landroidx/appcompat/widget/v0;->t(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/v0;
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/v0;->m(II)I
    ...
    invoke-virtual {p1, v0, v2}, Landroidx/appcompat/widget/v0;->j(II)I
    ...
    invoke-virtual {p1, v2, v3}, Landroidx/appcompat/widget/v0;->j(II)I
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/v0;->o(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/v0;->n(I)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/v0;->r(I)Z
    ...
    iput-object v0, p0, Lj/g$b;->A:La1/b;
    ...
    :cond_3
    iput-object v4, p0, Lj/g$b;->A:La1/b;
