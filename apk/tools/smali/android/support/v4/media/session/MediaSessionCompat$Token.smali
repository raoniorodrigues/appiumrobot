...
.field private h:Landroid/support/v4/media/session/b;
...
.method constructor <init>(Ljava/lang/Object;Landroid/support/v4/media/session/b;Landroid/os/Bundle;)V
    ...
    iput-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->h:Landroid/support/v4/media/session/b;

    iput-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->i:Landroid/os/Bundle;
...
.method public a()Landroid/support/v4/media/session/b;
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->h:Landroid/support/v4/media/session/b;
...
.method public b(Landroid/support/v4/media/session/b;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->h:Landroid/support/v4/media/session/b;
...
.method public c(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->i:Landroid/os/Bundle;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    :cond_0
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->g:Ljava/lang/Object;
