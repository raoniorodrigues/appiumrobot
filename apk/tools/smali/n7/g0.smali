...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ln7/g0;->a:Ljava/util/Random;

    sget-object v0, Ln7/b0;->a:Ln7/b0;

    sput-object v0, Ln7/g0;->b:Lcom/google/android/gms/tasks/Continuation;
...
.method public static C()Lcom/google/android/gms/tasks/Continuation;
    ...
    sget-object v0, Ln7/g0;->b:Lcom/google/android/gms/tasks/Continuation;
...
.method public static synthetic a(Ljava/lang/RuntimeException;)V
    ...
    invoke-static {p0}, Ln7/g0;->v(Ljava/lang/RuntimeException;)V
...
.method public static synthetic b(Ljava/lang/Comparable;Ljava/lang/Comparable;)I
    ...
    invoke-static {p0, p1}, Ln7/g0;->w(Ljava/lang/Comparable;Ljava/lang/Comparable;)I
...
.method public static synthetic c(Ljava/util/Comparator;Ljava/util/Map$Entry;Ljava/util/Map$Entry;)I
    ...
    invoke-static {p0, p1, p2}, Ln7/g0;->x(Ljava/util/Comparator;Ljava/util/Map$Entry;Ljava/util/Map$Entry;)I
...
.method public static synthetic d(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Void;
    ...
    invoke-static {p0}, Ln7/g0;->y(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Void;
...
.method public static g()Ljava/util/Comparator;
    ...
    sget-object v0, Ln7/f0;->g:Ln7/f0;
...
.method public static k(DD)I
    ...
    invoke-static {p0, p1, p2, p3}, Ld5/a;->c(DD)I
...
.method public static m(JJ)I
    ...
    invoke-static {p0, p1, p2, p3}, Ld5/a;->a(JJ)I
...
.method public static n(DJ)I
    ...
    invoke-static {p0, p1, p2, p3}, Ld5/a;->b(DJ)I
...
.method private static o(Ljava/lang/Exception;)Ljava/lang/Exception;
    ...
    instance-of v0, p0, Lnb/k1;

    if-eqz v0, :cond_0

    check-cast p0, Lnb/k1;

    invoke-virtual {p0}, Lnb/k1;->a()Lnb/j1;

    move-result-object p0

    :goto_0
    invoke-static {p0}, Ln7/g0;->t(Lnb/j1;)Lcom/google/firebase/firestore/z;
    ...
    :cond_0
    instance-of v0, p0, Lnb/l1;

    if-eqz v0, :cond_1

    check-cast p0, Lnb/l1;

    invoke-virtual {p0}, Lnb/l1;->a()Lnb/j1;
...
.method public static p(Ljava/lang/RuntimeException;)V
    ...
    invoke-direct {v1, p0}, Ln7/c0;-><init>(Ljava/lang/RuntimeException;)V
...
.method public static q(Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Comparator;Ln7/n;Ln7/n;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1, p0, p2, p3, p4}, Ln7/g0;->r(Ljava/util/Iterator;Ljava/util/Iterator;Ljava/util/Comparator;Ln7/n;Ln7/n;)V

    return-void
.end method

.method private static r(Ljava/util/Iterator;Ljava/util/Iterator;Ljava/util/Comparator;Ln7/n;Ln7/n;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    :cond_0
    invoke-static {p0}, Ln7/g0;->e(Ljava/util/Iterator;)Ljava/lang/Object;

    move-result-object v0

    :goto_0
    invoke-static {p1}, Ln7/g0;->e(Ljava/util/Iterator;)Ljava/lang/Object;
    ...
    invoke-interface {p3, v1}, Ln7/n;->accept(Ljava/lang/Object;)V
    ...
    invoke-interface {p4, v0}, Ln7/n;->accept(Ljava/lang/Object;)V
...
.method public static s(Ljava/util/SortedSet;Ljava/util/SortedSet;Ln7/n;Ln7/n;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
    ...
    :cond_0
    sget-object p0, Ln7/e0;->g:Ln7/e0;

    :goto_0
    invoke-static {v0, p1, p0, p2, p3}, Ln7/g0;->r(Ljava/util/Iterator;Ljava/util/Iterator;Ljava/util/Comparator;Ln7/n;Ln7/n;)V

    return-void
.end method

.method public static t(Lnb/j1;)Lcom/google/firebase/firestore/z;
    .locals 3

    invoke-virtual {p0}, Lnb/j1;->c()Lnb/k1;
...
.method public static u(Ljava/util/Map;ILjava/util/Comparator;)Ljava/util/Map;
    ...
    new-instance p0, Ln7/d0;

    invoke-direct {p0, p2}, Ln7/d0;-><init>(Ljava/util/Comparator;)V
...
.method private static synthetic y(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Void;
    ...
    invoke-static {p0}, Ln7/g0;->o(Ljava/lang/Exception;)Ljava/lang/Exception;
    ...
    sget-object v2, Lcom/google/firebase/firestore/z$a;->j:Lcom/google/firebase/firestore/z$a;
