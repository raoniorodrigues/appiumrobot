...
# direct methods
.method constructor <init>(Landroid/database/sqlite/SQLiteDatabase;Li7/o;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Li7/z3;->a:Landroid/database/sqlite/SQLiteDatabase;

    iput-object p2, p0, Li7/z3;->b:Li7/o;
...
.method private A()V
    ...
    new-instance v1, Li7/r3;

    invoke-direct {v1, p0}, Li7/r3;-><init>(Li7/z3;)V

    invoke-direct {p0, v0, v1}, Li7/z3;->N([Ljava/lang/String;Ljava/lang/Runnable;)V
...
.method private B()V
    ...
    new-instance v1, Li7/w3;

    invoke-direct {v1, p0}, Li7/w3;-><init>(Li7/z3;)V
...
.method private C()V
    ...
    new-instance v1, Li7/h3;

    invoke-direct {v1, p0}, Li7/h3;-><init>(Li7/z3;)V
...
.method private D()V
    ...
    new-instance v1, Li7/q3;

    invoke-direct {v1, p0}, Li7/q3;-><init>(Li7/z3;)V
...
.method private E()V
    ...
    new-instance v1, Li7/s3;

    invoke-direct {v1, p0}, Li7/s3;-><init>(Li7/z3;)V
    ...
    iget-object v1, p0, Li7/z3;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    new-instance v2, Li7/x3;

    invoke-direct {v2, v0, v1}, Li7/x3;-><init>(Li7/t0$a;Landroid/database/sqlite/SQLiteStatement;)V
    ...
    invoke-direct {v0, v1, v3}, Li7/a3$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V

    new-instance v1, Li7/l3;

    invoke-direct {v1, v2}, Li7/l3;-><init>(Ln7/n;)V
    ...
    new-instance v1, Li7/m3;

    invoke-direct {v1, v2}, Li7/m3;-><init>(Ln7/n;)V
...
.method private F()V
    ...
    invoke-direct {v0, v1, v2}, Li7/a3$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V

    new-instance v1, Li7/y3;

    invoke-direct {v1, p0}, Li7/y3;-><init>(Li7/z3;)V
...
.method private G()V
    ...
    invoke-direct {p0, v0}, Li7/z3;->m0(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Li7/z3;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method private H()V
    ...
    iget-object v2, p0, Li7/z3;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    new-instance v3, Li7/n3;

    invoke-direct {v3, v1, v2}, Li7/n3;-><init>([ZLandroid/database/sqlite/SQLiteStatement;)V

    invoke-virtual {v0, v3}, Li7/a3$d;->e(Ln7/n;)I
...
.method private J()V
    ...
    sget-object v1, Li7/p3;->a:Li7/p3;
    ...
    new-instance v5, Li7/a3$d;

    iget-object v6, p0, Li7/z3;->a:Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-direct {v5, v6, v7}, Li7/a3$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v6}, Li7/a3$d;->b([Ljava/lang/Object;)Li7/a3$d;
    ...
    new-instance v6, Li7/o3;

    invoke-direct {v6, v1, v0, v3, v4}, Li7/o3;-><init>([ZLandroid/database/sqlite/SQLiteStatement;J)V

    invoke-virtual {v5, v6}, Li7/a3$d;->e(Ln7/n;)I
...
.method private M()Z
    ...
    invoke-direct {p0, v0, v1}, Li7/z3;->l0(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v1

    const-string v2, "read_time_nanos"

    invoke-direct {p0, v0, v2}, Li7/z3;->l0(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private N([Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p0, v4}, Li7/z3;->m0(Ljava/lang/String;)Z
    ...
    invoke-static {v0, p1, p2}, Ln7/v;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static synthetic V(Li7/t0$a;Landroid/database/sqlite/SQLiteStatement;Lj7/t;)V
    .locals 1

    invoke-virtual {p0, p2}, Li7/t0$a;->a(Lj7/t;)Z
    ...
    invoke-virtual {p2}, Lj7/e;->u()Lj7/e;
    ...
    invoke-static {p2}, Li7/f;->c(Lj7/e;)Ljava/lang/String;
...
.method private static synthetic W(Ln7/n;Landroid/database/Cursor;)V
    .locals 1
...
.method private static synthetic X(Ln7/n;Landroid/database/Cursor;)V
    .locals 1
...
.method private synthetic Z(Landroid/database/Cursor;)V
    ...
    invoke-virtual {p1}, Ll7/c$b;->E()Ll7/c$b;
    ...
    iget-object v3, p0, Li7/z3;->a:Landroid/database/sqlite/SQLiteDatabase;
...
.method public static synthetic a(Li7/z3;)V
    .locals 0

    invoke-direct {p0}, Li7/z3;->T()V
...
.method private static synthetic a0([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
    ...
    invoke-static {p0}, Li7/f;->b(Ljava/lang/String;)Lj7/t;
    ...
    invoke-static {v1, p1, p0}, Ln7/b;->d(ZLjava/lang/String;[Ljava/lang/Object;)V

    return-void
.end method

.method public static synthetic b(Li7/z3;)V
    .locals 0

    invoke-direct {p0}, Li7/z3;->U()V
...
.method public static synthetic c(Li7/z3;)V
    .locals 0

    invoke-direct {p0}, Li7/z3;->R()V
...
.method public static synthetic d(Landroid/database/Cursor;)Ljava/lang/Long;
    ...
    invoke-static {p0}, Li7/z3;->b0(Landroid/database/Cursor;)Ljava/lang/Long;
...
.method private synthetic d0(Ljava/lang/String;Landroid/database/Cursor;)V
    ...
    invoke-direct {p0, p1, p2}, Li7/z3;->h0(Ljava/lang/String;I)V
...
.method public static synthetic e([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
    ...
    invoke-static {p0, p1, p2}, Li7/z3;->a0([ZLandroid/database/sqlite/SQLiteStatement;Landroid/database/Cursor;)V
...
.method private synthetic e0(Landroid/database/Cursor;)V
    ...
    new-instance p1, Li7/a3$d;

    iget-object v5, p0, Li7/z3;->a:Landroid/database/sqlite/SQLiteDatabase;

    const-string v6, "SELECT batch_id FROM mutations WHERE uid = ? AND batch_id <= ?"

    invoke-direct {p1, v5, v6}, Li7/a3$d;-><init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v5}, Li7/a3$d;->b([Ljava/lang/Object;)Li7/a3$d;

    move-result-object p1

    new-instance v0, Li7/k3;

    invoke-direct {v0, p0, v1}, Li7/k3;-><init>(Li7/z3;Ljava/lang/String;)V
...
.method public static synthetic f(Li7/t0$a;Landroid/database/sqlite/SQLiteStatement;Lj7/t;)V
    .locals 0

    invoke-static {p0, p1, p2}, Li7/z3;->V(Li7/t0$a;Landroid/database/sqlite/SQLiteStatement;Lj7/t;)V
...
.method private synthetic f0(Landroid/database/Cursor;)V
    ...
    iget-object v3, p0, Li7/z3;->b:Li7/o;

    invoke-virtual {v3, p1}, Li7/o;->h(Ll7/c;)Li7/i4;
...
.method public static synthetic g(Li7/z3;)V
    .locals 0

    invoke-direct {p0}, Li7/z3;->Y()V
...
.method private g0()V
    ...
    new-instance v1, Li7/j3;

    invoke-direct {v1, p0}, Li7/j3;-><init>(Li7/z3;)V
...
.method public static synthetic h(Ln7/n;Landroid/database/Cursor;)V
    .locals 0

    invoke-static {p0, p1}, Li7/z3;->W(Ln7/n;Landroid/database/Cursor;)V
...
.method public static synthetic i(Li7/z3;)V
    .locals 0

    invoke-direct {p0}, Li7/z3;->P()V
...
.method private i0()V
    ...
    new-instance v1, Li7/i3;

    invoke-direct {v1, p0}, Li7/i3;-><init>(Li7/z3;)V
...
.method public static synthetic j(Li7/z3;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Li7/z3;->Z(Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic k(Li7/z3;)V
    .locals 0

    invoke-direct {p0}, Li7/z3;->O()V

    return-void
.end method

.method public static synthetic l(Li7/z3;)V
    .locals 0

    invoke-direct {p0}, Li7/z3;->Q()V
...
.method private l0(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Li7/z3;->L(Ljava/lang/String;)Ljava/util/List;
...
.method public static synthetic m(Li7/z3;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Li7/z3;->f0(Landroid/database/Cursor;)V
...
.method public static synthetic n(Li7/z3;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1}, Li7/z3;->e0(Landroid/database/Cursor;)V
...
.method public static synthetic o([ZLandroid/database/sqlite/SQLiteStatement;JLandroid/database/Cursor;)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, Li7/z3;->c0([ZLandroid/database/sqlite/SQLiteStatement;JLandroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic p(Li7/z3;Ljava/lang/String;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Li7/z3;->d0(Ljava/lang/String;Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic q(Ln7/n;Landroid/database/Cursor;)V
    .locals 0

    invoke-static {p0, p1}, Li7/z3;->X(Ln7/n;Landroid/database/Cursor;)V

    return-void
.end method

.method public static synthetic r(Li7/z3;)V
    .locals 0

    invoke-direct {p0}, Li7/z3;->S()V
...
.method private x()V
    ...
    new-instance v1, Li7/u3;

    invoke-direct {v1, p0}, Li7/u3;-><init>(Li7/z3;)V
...
.method private y()V
    ...
    new-instance v1, Li7/t3;

    invoke-direct {v1, p0}, Li7/t3;-><init>(Li7/z3;)V
...
.method private z()V
    ...
    new-instance v1, Li7/v3;

    invoke-direct {v1, p0}, Li7/v3;-><init>(Li7/z3;)V
...
.method j0(I)V
    ...
    invoke-virtual {p0, p1, v0}, Li7/z3;->k0(II)V
...
.method k0(II)V
    ...
    invoke-direct {p0}, Li7/z3;->B()V

    invoke-direct {p0}, Li7/z3;->D()V

    invoke-direct {p0}, Li7/z3;->C()V
    ...
    invoke-direct {p0}, Li7/z3;->K()V

    invoke-direct {p0}, Li7/z3;->w()V
    ...
    invoke-direct {p0}, Li7/z3;->A()V

    invoke-direct {p0}, Li7/z3;->y()V

    sget-object v4, Li7/e1;->b:Ljava/lang/String;

    invoke-direct {p0, v4}, Li7/z3;->t(Ljava/lang/String;)V
    ...
    invoke-static {p1, p2, v3}, Ln7/v;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
