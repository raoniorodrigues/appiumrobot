...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ll2/j;->c:Ljava/util/Set;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, Ll2/j;->d:Ljava/util/Map;
...
.method public static final d()Z
    ...
    :cond_0
    :try_start_0
    sget-object v2, Ll2/j;->a:Ll2/j;

    invoke-direct {v2}, Ll2/j;->g()V
    ...
    sget-object v2, Ll2/j;->b:Landroid/content/SharedPreferences;
    :try_end_0
...
.method public static final e(Ljava/util/Map;Ljava/util/Map;)V
    ...
    invoke-direct {v1}, Ll2/j;->g()V

    invoke-virtual {v1, p0}, Ll2/j;->a(Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-virtual {v1, p0, p1}, Ll2/j;->c(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-direct {v1, p0}, Ll2/j;->f(Ljava/util/Map;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final f(Ljava/util/Map;)V
    ...
    invoke-static {v1, v0, v2}, Ln2/i;->f(Ljava/lang/String;Ljava/lang/String;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final g()V
    ...
    sput-object v0, Ll2/j;->b:Landroid/content/SharedPreferences;

    sget-object v1, Ll2/j;->c:Ljava/util/Set;
    ...
    sget-object v3, Ll2/j;->d:Ljava/util/Map;
...
.method public final a(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lzb/c0;->m(Ljava/util/Map;)Ljava/util/Map;
    ...
    sget-object v7, Ll2/j;->d:Ljava/util/Map;
    ...
    :cond_2
    sget-object v6, Ll2/j;->c:Ljava/util/Set;
    ...
    :cond_3
    :try_start_2
    sget-object v0, Ll2/j;->b:Landroid/content/SharedPreferences;
    ...
    sget-object v3, Ll2/j;->c:Ljava/util/Set;
...
.method public final b()V
    ...
    sget-object v3, Ll2/j;->b:Landroid/content/SharedPreferences;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v3}, Lzb/c0;->m(Ljava/util/Map;)Ljava/util/Map;
    ...
    sget-object v6, Ll2/j;->d:Ljava/util/Map;
    ...
    sget-object v5, Ll2/j;->c:Ljava/util/Set;
