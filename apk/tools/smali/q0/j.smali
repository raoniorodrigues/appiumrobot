...
# direct methods
.method constructor <init>(Lq0/i$d;)V
    .locals 13
    ...
    iput-object v0, p0, Lq0/j;->f:Ljava/util/List;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, Lq0/j;->g:Landroid/os/Bundle;

    iput-object p1, p0, Lq0/j;->c:Lq0/i$d;

    iget-object v0, p1, Lq0/i$d;->a:Landroid/content/Context;

    iput-object v0, p0, Lq0/j;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, Lq0/i$d;->a:Landroid/content/Context;

    if-lt v0, v1, :cond_0

    iget-object v4, p1, Lq0/i$d;->K:Ljava/lang/String;
    ...
    :goto_0
    iput-object v2, p0, Lq0/j;->b:Landroid/app/Notification$Builder;

    iget-object v2, p1, Lq0/i$d;->R:Landroid/app/Notification;

    iget-object v3, p0, Lq0/j;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, Lq0/i$d;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, Lq0/i$d;->e:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lq0/i$d;->f:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lq0/i$d;->k:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, Lq0/i$d;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lq0/i$d;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, Lq0/i$d;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, Lq0/i$d;->l:I

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v4, p1, Lq0/i$d;->t:I

    iget v9, p1, Lq0/i$d;->u:I

    iget-boolean v10, p1, Lq0/i$d;->v:Z
    ...
    iget-object v4, p0, Lq0/j;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Lq0/j;->b:Landroid/app/Notification$Builder;

    iget-object v8, p1, Lq0/i$d;->q:Ljava/lang/CharSequence;
    ...
    check-cast v8, Lq0/i$a;

    invoke-direct {p0, v8}, Lq0/j;->b(Lq0/i$a;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, Lq0/i$d;->D:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    iget-object v8, p0, Lq0/j;->g:Landroid/os/Bundle;
    ...
    iget-boolean v0, p1, Lq0/i$d;->z:Z

    if-eqz v0, :cond_8

    iget-object v0, p0, Lq0/j;->g:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v0, p1, Lq0/i$d;->w:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Lq0/i$d;->x:Z
    ...
    :cond_a
    iget-object v0, p1, Lq0/i$d;->y:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p1, Lq0/i$d;->H:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lq0/j;->d:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lq0/i$d;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lq0/j;->e:Landroid/widget/RemoteViews;
    ...
    iget-object v8, p0, Lq0/j;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, Lq0/i$d;->n:Z
    ...
    iget-object v8, p1, Lq0/i$d;->c:Ljava/util/ArrayList;

    invoke-static {v8}, Lq0/j;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, Lq0/i$d;->U:Ljava/util/ArrayList;

    invoke-static {v8, v9}, Lq0/j;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v9, p0, Lq0/j;->g:Landroid/os/Bundle;
    ...
    iget-object v0, p1, Lq0/i$d;->c:Ljava/util/ArrayList;

    invoke-static {v0}, Lq0/j;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, Lq0/i$d;->U:Ljava/util/ArrayList;

    invoke-static {v0, v3}, Lq0/j;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    :cond_10
    iget-object v0, p1, Lq0/i$d;->U:Ljava/util/ArrayList;
    ...
    :cond_11
    iget-object v0, p1, Lq0/i$d;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lq0/j;->i:Landroid/widget/RemoteViews;

    iget-object v0, p1, Lq0/i$d;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Lq0/i$d;->c()Landroid/os/Bundle;
    ...
    :goto_9
    iget-object v11, p1, Lq0/i$d;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Lq0/i$d;->d:Ljava/util/ArrayList;

    invoke-virtual {v12, v10}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, Lq0/i$a;

    invoke-static {v12}, Lq0/k;->b(Lq0/i$a;)Landroid/os/Bundle;
    ...
    iget-object v3, p1, Lq0/i$d;->T:Landroid/graphics/drawable/Icon;
    ...
    iget-object v3, p1, Lq0/i$d;->H:Landroid/widget/RemoteViews;
    ...
    :cond_16
    iget-object v3, p1, Lq0/i$d;->I:Landroid/widget/RemoteViews;
    ...
    :cond_17
    iget-object v3, p1, Lq0/i$d;->J:Landroid/widget/RemoteViews;
    ...
    iget-object v7, p0, Lq0/j;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, Lq0/m;->h()Landroid/app/Person;
    ...
    iget-boolean v7, p1, Lq0/i$d;->P:Z
    ...
    iget-object v7, p1, Lq0/i$d;->Q:Lq0/i$c;

    invoke-static {v7}, Lq0/i$c;->a(Lq0/i$c;)Landroid/app/Notification$BubbleMetadata;
    ...
    :cond_1c
    iget-boolean p1, p1, Lq0/i$d;->S:Z

    if-eqz p1, :cond_1f

    iget-object p1, p0, Lq0/j;->c:Lq0/i$d;

    iget-boolean p1, p1, Lq0/i$d;->x:Z

    if-eqz p1, :cond_1d

    iput v5, p0, Lq0/j;->h:I

    goto :goto_b

    :cond_1d
    iput v6, p0, Lq0/j;->h:I

    :goto_b
    iget-object p1, p0, Lq0/j;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p0, Lq0/j;->b:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Lq0/i$d;->w:Ljava/lang/String;
...
.method private b(Lq0/i$a;)V
    ...
    invoke-virtual {p1}, Lq0/i$a;->e()Landroidx/core/graphics/drawable/IconCompat;
    ...
    :goto_0
    invoke-virtual {p1}, Lq0/i$a;->i()Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {p1}, Lq0/i$a;->a()Landroid/app/PendingIntent;
    ...
    :goto_2
    invoke-virtual {p1}, Lq0/i$a;->f()[Lq0/n;
    ...
    invoke-static {v1}, Lq0/n;->b([Lq0/n;)[Landroid/app/RemoteInput;
    ...
    :cond_3
    invoke-virtual {p1}, Lq0/i$a;->d()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Lq0/j;->f:Ljava/util/List;

    iget-object v1, p0, Lq0/j;->b:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Lq0/k;->f(Landroid/app/Notification$Builder;Lq0/i$a;)Landroid/os/Bundle;
...
.method private static f(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lq0/m;->g()Ljava/lang/String;
...
.method public c()Landroid/app/Notification;
    ...
    iget-object v0, p0, Lq0/j;->c:Lq0/i$d;

    iget-object v0, v0, Lq0/i$d;->p:Lq0/i$e;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Lq0/i$e;->b(Lq0/h;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Lq0/i$e;->e(Lq0/h;)Landroid/widget/RemoteViews;
    ...
    :goto_0
    invoke-virtual {p0}, Lq0/j;->d()Landroid/app/Notification;
    ...
    :cond_2
    iget-object v1, p0, Lq0/j;->c:Lq0/i$d;

    iget-object v1, v1, Lq0/i$d;->H:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Lq0/i$e;->d(Lq0/h;)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, Lq0/j;->c:Lq0/i$d;

    iget-object v4, v4, Lq0/i$d;->p:Lq0/i$e;

    invoke-virtual {v4, p0}, Lq0/i$e;->f(Lq0/h;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, Lq0/i;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-virtual {v0, v1}, Lq0/i$e;->a(Landroid/os/Bundle;)V
...
.method protected d()Landroid/app/Notification;
    ...
    invoke-direct {p0, v0}, Lq0/j;->g(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, Lq0/j;->g:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lq0/j;->d:Landroid/widget/RemoteViews;
    ...
    :cond_4
    iget-object v1, p0, Lq0/j;->e:Landroid/widget/RemoteViews;
    ...
    :cond_5
    iget-object v1, p0, Lq0/j;->i:Landroid/widget/RemoteViews;
    ...
    invoke-static {v0}, Lq0/k;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    invoke-static {v0}, Lq0/i;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    new-instance v3, Landroid/os/Bundle;

    iget-object v4, p0, Lq0/j;->g:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lq0/j;->f:Ljava/util/List;

    invoke-static {v1}, Lq0/k;->a(Ljava/util/List;)Landroid/util/SparseArray;
