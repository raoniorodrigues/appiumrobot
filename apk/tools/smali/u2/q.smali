...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lkotlin/jvm/internal/w;->b(Ljava/lang/Class;)Lpc/c;

    move-result-object v0

    invoke-interface {v0}, Lpc/c;->b()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lu2/q;->b:Ljava/lang/String;
    ...
    sput-object v0, Lu2/q;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    sput-object v0, Lu2/q;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, Lu2/q;->e:Ljava/util/Map;
...
.method public static synthetic a(Lu2/q$a;)V
    .locals 0

    invoke-static {p0}, Lu2/q;->l(Lu2/q$a;)V
...
.method public static synthetic b(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, p2}, Lu2/q;->i(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
...
.method private final c(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-virtual {v0, v2, v1, v2}, Le2/i0$c;->x(Le2/a;Ljava/lang/String;Le2/i0$b;)Le2/i0;
...
.method public static final d(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v0, p1}, Lu2/q;->e(Ljava/lang/String;)Ljava/util/Map;
...
.method public static final declared-synchronized h(Lu2/q$a;)V
    .locals 8
    ...
    :try_start_0
    sget-object v1, Lu2/q;->d:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    sget-object v2, Lu2/q;->f:Ljava/lang/Long;

    invoke-direct {v1, v2}, Lu2/q;->f(Ljava/lang/Long;)Z

    move-result v2

    if-eqz v2, :cond_1

    sget-object v2, Lu2/q;->e:Ljava/util/Map;
    ...
    invoke-static {v4}, Lu2/k0;->X(Ljava/lang/String;)Z
    ...
    invoke-static {v7, v4}, Lu2/k0;->d0(Ljava/lang/String;Ljava/lang/Exception;)V

    :goto_0
    if-eqz v6, :cond_3

    invoke-static {p0, v6}, Lu2/q;->j(Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_4
    :try_start_5
    sget-object v6, Lu2/q;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v3, p0, v1, v2}, Lu2/o;-><init>(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
...
.method private static final i(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0}, Lu2/q;->c(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-static {p0, v1}, Lu2/q;->j(Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    sput-object p0, Lu2/q;->f:Ljava/lang/Long;

    :cond_0
    invoke-direct {v0}, Lu2/q;->k()V

    sget-object p0, Lu2/q;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static final declared-synchronized j(Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    sget-object v1, Lu2/q;->e:Ljava/util/Map;
    ...
    invoke-static {v5, v2}, Lu2/k0;->d0(Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    :cond_6
    :goto_3
    sget-object p1, Lu2/q;->e:Ljava/util/Map;
...
.method private final k()V
    ...
    check-cast v1, Lu2/q$a;

    if-eqz v1, :cond_0

    new-instance v2, Lu2/p;

    invoke-direct {v2, v1}, Lu2/p;-><init>(Lu2/q$a;)V
...
.method private static final l(Lu2/q$a;)V
    .locals 0

    invoke-interface {p0}, Lu2/q$a;->a()V
...
.method public static final m(Ljava/lang/String;Z)Lorg/json/JSONObject;
    ...
    invoke-direct {p1, p0}, Lu2/q;->c(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-static {p0, p1}, Lu2/q;->j(Ljava/lang/String;Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method public final e(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-virtual {p0}, Lu2/q;->g()V

    if-eqz p1, :cond_8

    sget-object v0, Lu2/q;->e:Ljava/util/Map;
    ...
    :cond_1
    invoke-virtual {v1, p1}, Lv2/b;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {v5, v6, v4}, Lv2/a;-><init>(Ljava/lang/String;Z)V
    ...
    :cond_6
    invoke-virtual {v0, p1, v2}, Lv2/b;->b(Ljava/lang/String;Ljava/util/List;)V

    sput-object v0, Lu2/q;->g:Lv2/b;
...
.method public final g()V
    ...
    invoke-static {v0}, Lu2/q;->h(Lu2/q$a;)V
