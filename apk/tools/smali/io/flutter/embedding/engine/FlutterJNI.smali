...
.field private deferredComponentManager:Lx9/a;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Lv9/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lw9/f;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Lw9/f;->g(ILjava/nio/ByteBuffer;)V
...
.method public addIsDisplayingFlutterUiListener(Lga/b;)V
    .locals 1
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lja/a;
    ...
    :cond_5
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lja/a;

    invoke-virtual {p1, v0}, Lja/a;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/p;->L()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Lv9/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/c$g;Ljava/lang/Object;)V
    ...
    sget-object v0, Lia/q;->a:Lia/q;

    invoke-virtual {v0, p3}, Lia/q;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/c$g;->g:I
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Lw9/f;->h(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public invokePlatformMessageEmptyResponseCallback(I)V
    ...
    invoke-static {v0, p1}, Lv9/b;->g(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onBeginFrame()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/p;->h0()V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/plugin/platform/p;->j0(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    iget-object v1, v0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/p;
    ...
    invoke-virtual/range {v1 .. v9}, Lio/flutter/plugin/platform/p;->k0(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public onEndFrame()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/p;->l0()V
...
.method public removeIsDisplayingFlutterUiListener(Lga/b;)V
    .locals 1
...
.method public requestDartDeferredLibrary(I)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lx9/a;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-interface {v0, p1, v1}, Lx9/a;->b(ILjava/lang/String;)V
...
.method public setDeferredComponentManager(Lx9/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lx9/a;

    if-eqz p1, :cond_0

    invoke-interface {p1, p0}, Lx9/a;->f(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Lja/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lja/a;

    return-void
.end method

.method public setPlatformMessageHandler(Lw9/f;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lw9/f;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Lmb/c;->a(ZLjava/lang/Object;)V
