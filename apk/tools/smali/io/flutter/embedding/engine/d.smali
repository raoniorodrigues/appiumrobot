...
.method public constructor <init>(Landroid/content/Context;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Ly9/d;->e(Landroid/content/Context;[Ljava/lang/String;)V
...
.method public a(Lio/flutter/embedding/engine/d$b;)Lio/flutter/embedding/engine/a;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/d$b;->c()Lw9/a$b;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/d$b;->f()Lio/flutter/plugin/platform/p;
    ...
    invoke-virtual {p0, v1, v5, v6, v7}, Lio/flutter/embedding/engine/d;->b(Landroid/content/Context;Lio/flutter/plugin/platform/p;ZZ)Lio/flutter/embedding/engine/a;

    move-result-object p1

    if-eqz v3, :cond_2

    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->n()Lha/i;

    move-result-object v0

    invoke-virtual {v0, v3}, Lha/i;->c(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, v4}, Lw9/a;->k(Lw9/a$b;Ljava/util/List;)V
    ...
    invoke-virtual/range {v0 .. v7}, Lio/flutter/embedding/engine/a;->y(Landroid/content/Context;Lw9/a$b;Ljava/lang/String;Ljava/util/List;Lio/flutter/plugin/platform/p;ZZ)Lio/flutter/embedding/engine/a;
...
.method b(Landroid/content/Context;Lio/flutter/plugin/platform/p;ZZ)Lio/flutter/embedding/engine/a;
    .locals 10
