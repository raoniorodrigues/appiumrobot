...
# static fields
.field private static final w:Ljava/lang/String; = "RecaptchaActivity"

.field private static x:J

.field private static final y:Lo5/b1;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->y:Lo5/b1;
...
.method static synthetic A(Landroid/net/Uri;Lcom/google/android/gms/tasks/Task;)Landroid/net/Uri;
    .locals 3
    ...
    invoke-virtual {p1}, Lm5/a;->a()Ljava/lang/Exception;

    move-result-object v0

    if-eqz v0, :cond_0

    sget-object v0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->w:Ljava/lang/String;
...
.method private final C()V
    ...
    sget-object v0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->y:Lo5/b1;
...
.method private final D(Lcom/google/android/gms/common/api/Status;)V
    ...
    sget-object p1, Lcom/google/firebase/auth/internal/RecaptchaActivity;->y:Lo5/b1;
...
# virtual methods
.method final synthetic B(Ljava/lang/String;Lcom/google/android/gms/tasks/Task;)V
    .locals 5
    ...
    :cond_1
    sget-object p2, Lcom/google/firebase/auth/internal/RecaptchaActivity;->w:Ljava/lang/String;
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    sget-object p1, Lcom/google/firebase/auth/internal/RecaptchaActivity;->w:Ljava/lang/String;
...
.method protected final onResume()V
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/auth/internal/RecaptchaActivity;->D(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v5, v6, v7, v4}, Lo5/j1;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v5, Lcom/google/firebase/auth/internal/RecaptchaActivity;->w:Ljava/lang/String;
    ...
    invoke-static {v5}, Lo5/l;->a(Ljava/lang/String;)Lcom/google/android/gms/common/api/Status;

    move-result-object v5

    invoke-direct {p0, v5}, Lcom/google/firebase/auth/internal/RecaptchaActivity;->D(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-static {v4}, Lj5/f;->p(Ljava/lang/String;)Lj5/f;

    move-result-object v1

    invoke-virtual {v1}, Lj5/f;->s()Ljava/lang/String;

    move-result-object v1

    invoke-static {v0, v1}, Lo5/k1;->a(Landroid/content/Context;Ljava/lang/String;)Lo5/k1;

    move-result-object v0

    invoke-virtual {v0, v3}, Lo5/k1;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-boolean v2, p0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->v:Z
    ...
    invoke-virtual {v4, v3}, Lr1/a;->d(Landroid/content/Intent;)Z
    ...
    :try_start_0
    invoke-static {p0, v4}, Lp4/a;->a(Landroid/content/Context;Ljava/lang/String;)[B
    ...
    invoke-static {v7}, Lcom/google/firebase/auth/FirebaseAuth;->getInstance(Lj5/f;)Lcom/google/firebase/auth/FirebaseAuth;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/google/android/gms/internal/firebase-auth-api/zzaeb;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;Lj5/f;Lcom/google/android/gms/internal/firebase-auth-api/zzaed;)V
    ...
    sget-object v2, Lcom/google/firebase/auth/internal/RecaptchaActivity;->w:Ljava/lang/String;
    ...
    :goto_1
    iput-boolean v1, p0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->v:Z
...
.method public final zzb(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri$Builder;
    ...
    invoke-static {v9}, Lcom/google/firebase/auth/FirebaseAuth;->getInstance(Lj5/f;)Lcom/google/firebase/auth/FirebaseAuth;
    ...
    invoke-virtual/range {v2 .. v7}, Lo5/j1;->e(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0}, Landroid/app/Activity;->getApplicationContext()Landroid/content/Context;

    move-result-object v2

    invoke-virtual {v9}, Lj5/f;->s()Ljava/lang/String;

    move-result-object v3

    invoke-static {v2, v3}, Lo5/k1;->a(Landroid/content/Context;Ljava/lang/String;)Lo5/k1;

    move-result-object v2

    invoke-virtual {v2}, Lo5/k1;->c()Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/auth/internal/RecaptchaActivity;->D(Lcom/google/android/gms/common/api/Status;)V
...
.method public final zzd(Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    :catch_0
    sget-object p1, Lcom/google/android/gms/internal/firebase-auth-api/zzaed;->zza:Lk4/a;
...
.method public final zze(Ljava/lang/String;Lcom/google/android/gms/common/api/Status;)V
    ...
    :cond_0
    invoke-direct {p0, p2}, Lcom/google/firebase/auth/internal/RecaptchaActivity;->D(Lcom/google/android/gms/common/api/Status;)V
...
.method public final zzf(Landroid/net/Uri;Ljava/lang/String;Lp7/b;)V
    ...
    :goto_0
    new-instance p3, Lcom/google/firebase/auth/internal/a;

    invoke-direct {p3, p0, p2}, Lcom/google/firebase/auth/internal/a;-><init>(Lcom/google/firebase/auth/internal/RecaptchaActivity;Ljava/lang/String;)V
