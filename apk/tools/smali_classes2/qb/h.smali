...
.field private static final d:Lqb/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lqb/h;->b:Ljava/util/logging/Logger;
    ...
    sput-object v0, Lqb/h;->c:[Ljava/lang/String;

    invoke-static {}, Lqb/h;->d()Lqb/h;
...
.method public constructor <init>(Ljava/security/Provider;)V
    ...
    iput-object p1, p0, Lqb/h;->a:Ljava/security/Provider;
...
.method public static b(Ljava/util/List;)[B
    ...
    :cond_0
    invoke-virtual {v3}, Lqb/i;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v0, v4}, Lokio/c;->A0(I)Lokio/c;

    invoke-virtual {v3}, Lqb/i;->toString()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v3}, Lokio/c;->F0(Ljava/lang/String;)Lokio/c;
...
.method private static d()Lqb/h;
    .locals 12

    const-class v0, [B

    invoke-static {}, Lqb/h;->f()Ljava/security/Provider;
    ...
    invoke-direct {v4, v2, v6, v5}, Lqb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V
    ...
    invoke-direct {v5, v2, v7, v6}, Lqb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    new-instance v6, Lqb/g;

    new-array v7, v3, [Ljava/lang/Class;

    const-string v9, "getAlpnSelectedProtocol"

    invoke-direct {v6, v0, v9, v7}, Lqb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    new-instance v7, Lqb/g;
    ...
    invoke-direct {v7, v2, v0, v9}, Lqb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V
    ...
    :cond_1
    invoke-static {}, Lqb/h;->j()Z

    move-result v1

    if-eqz v1, :cond_2

    sget-object v1, Lqb/h$h;->h:Lqb/h$h;

    goto :goto_2

    :cond_2
    sget-object v1, Lqb/h$h;->i:Lqb/h$h;

    goto :goto_2

    :cond_3
    :goto_1
    sget-object v1, Lqb/h$h;->g:Lqb/h$h;

    :goto_2
    move-object v10, v1

    new-instance v11, Lqb/h$d;
    ...
    invoke-direct/range {v1 .. v9}, Lqb/h$d;-><init>(Lqb/g;Lqb/g;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Lqb/g;Lqb/g;Ljava/security/Provider;Lqb/h$h;)V
    ...
    new-instance v5, Lqb/h$a;

    invoke-direct {v5}, Lqb/h$a;-><init>()V
    ...
    new-instance v4, Lqb/h$b;

    invoke-direct {v4}, Lqb/h$b;-><init>()V
    ...
    new-instance v5, Lqb/h$c;

    invoke-direct {v5}, Lqb/h$c;-><init>()V
    ...
    new-instance v6, Lqb/h$e;

    invoke-direct {v6, v0, v4, v5, v2}, Lqb/h$e;-><init>(Ljava/security/Provider;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Lqb/h$a;)V
    :try_end_3
    ...
    new-instance v1, Lqb/h$f;

    move-object v4, v1

    move-object v10, v0

    invoke-direct/range {v4 .. v10}, Lqb/h$f;-><init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/Class;Ljava/lang/Class;Ljava/security/Provider;)V
    :try_end_5
    ...
    invoke-direct {v1, v0}, Lqb/h;-><init>(Ljava/security/Provider;)V
...
.method private static f()Ljava/security/Provider;
    ...
    sget-object v5, Lqb/h;->c:[Ljava/lang/String;
    ...
    sget-object v0, Lqb/h;->b:Ljava/util/logging/Logger;
...
.method private static j()Z
    ...
    sget-object v1, Lqb/h;->b:Ljava/util/logging/Logger;
...
.method public g()Ljava/security/Provider;
    ...
    iget-object v0, p0, Lqb/h;->a:Ljava/security/Provider;
