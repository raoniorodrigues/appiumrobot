...
# static fields
.field private static final e:Lqb/g;
...
.field private static final f:Lqb/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lqb/g<",
            "Ljava/net/Socket;",
...
.field private static final g:Lqb/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lqb/g<",
            "Ljava/net/Socket;",
...
.field private static final h:Lqb/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lqb/g<",
            "Ljava/net/Socket;",
...
.field private static final i:Lqb/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lqb/g<",
            "Ljava/net/Socket;",
...
.field private static final j:Lqb/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lqb/g<",
            "Ljava/net/Socket;",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v4, v9, v10, v6}, Lqb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    sput-object v4, Lpb/k$a;->e:Lqb/g;
    ...
    invoke-direct {v4, v9, v11, v6}, Lqb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    sput-object v4, Lpb/k$a;->f:Lqb/g;
    ...
    invoke-direct {v4, v3, v11, v6}, Lqb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    sput-object v4, Lpb/k$a;->g:Lqb/g;
    ...
    sput-object v4, Lpb/k$a;->h:Lqb/g;
    ...
    sput-object v4, Lpb/k$a;->i:Lqb/g;
    ...
    invoke-direct {v4, v9, v3, v6}, Lqb/g;-><init>(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)V

    sput-object v4, Lpb/k$a;->j:Lqb/g;
    ...
    :goto_2
    invoke-static {}, Lpb/k;->a()Ljava/util/logging/Logger;
    ...
    :goto_3
    sput-object v4, Lpb/k$a;->m:Ljava/lang/reflect/Method;

    sput-object v3, Lpb/k$a;->n:Ljava/lang/reflect/Method;

    sput-object v6, Lpb/k$a;->o:Ljava/lang/reflect/Method;

    sput-object v12, Lpb/k$a;->k:Ljava/lang/reflect/Method;

    sput-object v1, Lpb/k$a;->l:Ljava/lang/reflect/Method;
    ...
    :goto_6
    sput-object v1, Lpb/k$a;->p:Ljava/lang/reflect/Method;

    sput-object v9, Lpb/k$a;->q:Ljava/lang/reflect/Constructor;
...
.method constructor <init>(Lqb/h;)V
    ...
    invoke-direct {p0, p1}, Lpb/k;-><init>(Lqb/h;)V
...
.method protected c(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-static {p3}, Lpb/k;->b(Ljava/util/List;)[Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p2}, Lpb/k;->g(Ljava/lang/String;)Z

    move-result v4

    if-eqz v4, :cond_2

    sget-object v4, Lpb/k$a;->k:Ljava/lang/reflect/Method;
    ...
    sget-object v4, Lpb/k$a;->l:Ljava/lang/reflect/Method;
    ...
    :cond_0
    sget-object v4, Lpb/k$a;->e:Lqb/g;
    ...
    invoke-virtual {v4, p1, v5}, Lqb/g;->e(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;

    :goto_0
    sget-object v4, Lpb/k$a;->p:Ljava/lang/reflect/Method;

    if-eqz v4, :cond_1

    sget-object v5, Lpb/k$a;->q:Ljava/lang/reflect/Constructor;
    ...
    :cond_1
    sget-object v4, Lpb/k$a;->f:Lqb/g;
    ...
    :cond_2
    :goto_1
    sget-object p2, Lpb/k$a;->o:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    sget-object p2, Lpb/k$a;->m:Ljava/lang/reflect/Method;
    ...
    sget-object p2, Lpb/k$a;->n:Ljava/lang/reflect/Method;
    ...
    iget-object p3, p0, Lpb/k;->a:Lqb/h;

    invoke-virtual {p3}, Lqb/h;->i()Lqb/h$h;

    move-result-object p3

    sget-object v0, Lqb/h$h;->g:Lqb/h$h;

    if-ne p3, v0, :cond_6

    sget-object p3, Lpb/k$a;->h:Lqb/g;
    ...
    sget-object v0, Lqb/h$h;->i:Lqb/h$h;

    if-eq p3, v0, :cond_7

    sget-object p3, Lpb/k$a;->j:Lqb/g;
...
.method public f(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    ...
    sget-object v0, Lpb/k$a;->o:Ljava/lang/reflect/Method;
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lpb/k;->a:Lqb/h;

    invoke-virtual {v0}, Lqb/h;->i()Lqb/h$h;

    move-result-object v0

    sget-object v2, Lqb/h$h;->g:Lqb/h$h;

    if-ne v0, v2, :cond_2

    :try_start_1
    sget-object v0, Lpb/k$a;->g:Lqb/g;
    ...
    sget-object v3, Lqb/l;->b:Ljava/nio/charset/Charset;
    ...
    sget-object v2, Lqb/h$h;->i:Lqb/h$h;

    if-eq v0, v2, :cond_3

    :try_start_2
    sget-object v0, Lpb/k$a;->i:Lqb/g;

    new-array v1, v1, [Ljava/lang/Object;

    invoke-virtual {v0, p1, v1}, Lqb/g;->f(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object v1, Lqb/l;->b:Ljava/nio/charset/Charset;
...
.method public h(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lpb/k$a;->f(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-super {p0, p1, p2, p3}, Lpb/k;->h(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
