...
.method constructor <init>(Lokio/c;)V
    ...
    iput-object p1, p0, Lpb/l;->g:Lokio/c;
...
.method public Q([BII)V
    ...
    iget-object v0, p0, Lpb/l;->g:Lokio/c;
...
.method public k0(Ljava/io/OutputStream;I)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Lokio/c;->E0(Ljava/io/OutputStream;J)Lokio/c;
...
.method public u(I)Lio/grpc/internal/v1;
    ...
    iget-object v1, p0, Lpb/l;->g:Lokio/c;

    int-to-long v2, p1

    invoke-virtual {v0, v1, v2, v3}, Lokio/c;->S(Lokio/c;J)V

    new-instance p1, Lpb/l;

    invoke-direct {p1, v0}, Lpb/l;-><init>(Lokio/c;)V
