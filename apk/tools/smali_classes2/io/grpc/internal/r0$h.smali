...
# static fields
.field public static final enum i:Lio/grpc/internal/r0$h;

.field public static final enum j:Lio/grpc/internal/r0$h;

.field public static final enum k:Lio/grpc/internal/r0$h;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v3, v3, v1}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V

    sput-object v0, Lio/grpc/internal/r0$h;->i:Lio/grpc/internal/r0$h;

    new-instance v2, Lio/grpc/internal/r0$h;

    sget-object v4, Lnb/j1;->t:Lnb/j1;

    const-string v5, "PROTOCOL_ERROR"

    const/4 v6, 0x1

    invoke-direct {v2, v5, v6, v6, v4}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V

    sput-object v2, Lio/grpc/internal/r0$h;->j:Lio/grpc/internal/r0$h;
    ...
    invoke-direct {v5, v7, v8, v8, v4}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V

    sput-object v5, Lio/grpc/internal/r0$h;->k:Lio/grpc/internal/r0$h;
    ...
    invoke-direct {v7, v9, v10, v10, v4}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V
    ...
    invoke-direct {v9, v11, v12, v12, v4}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V
    ...
    invoke-direct {v11, v13, v14, v14, v4}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V
    ...
    invoke-direct {v13, v15, v14, v14, v4}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V
    ...
    invoke-direct {v15, v14, v12, v12, v1}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V

    sput-object v15, Lio/grpc/internal/r0$h;->p:Lio/grpc/internal/r0$h;

    new-instance v1, Lio/grpc/internal/r0$h;

    sget-object v14, Lnb/j1;->g:Lnb/j1;

    const-string v12, "CANCEL"

    const/16 v10, 0x8

    invoke-direct {v1, v12, v10, v10, v14}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V
    ...
    invoke-direct {v12, v14, v10, v10, v4}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V
    ...
    invoke-direct {v14, v10, v8, v8, v4}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V

    sput-object v14, Lio/grpc/internal/r0$h;->s:Lio/grpc/internal/r0$h;

    new-instance v4, Lio/grpc/internal/r0$h;

    sget-object v10, Lnb/j1;->o:Lnb/j1;

    const-string v8, "Bandwidth exhausted"

    invoke-virtual {v10, v8}, Lnb/j1;->q(Ljava/lang/String;)Lnb/j1;
    ...
    invoke-direct {v8, v10, v3, v3, v6}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V

    sput-object v8, Lio/grpc/internal/r0$h;->u:Lio/grpc/internal/r0$h;

    new-instance v6, Lio/grpc/internal/r0$h;

    sget-object v10, Lnb/j1;->h:Lnb/j1;
    ...
    invoke-direct {v6, v3, v8, v8, v10}, Lio/grpc/internal/r0$h;-><init>(Ljava/lang/String;IILnb/j1;)V
    ...
    invoke-static {}, Lio/grpc/internal/r0$h;->c()[Lio/grpc/internal/r0$h;
...
.method private constructor <init>(Ljava/lang/String;IILnb/j1;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    iput p3, p0, Lio/grpc/internal/r0$h;->g:I
    ...
    invoke-virtual {p4}, Lnb/j1;->n()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p4, p1}, Lnb/j1;->q(Ljava/lang/String;)Lnb/j1;

    move-result-object p1

    iput-object p1, p0, Lio/grpc/internal/r0$h;->h:Lnb/j1;

    return-void
.end method

.method private static c()[Lio/grpc/internal/r0$h;
    .locals 7
    ...
    invoke-virtual {v1}, Lio/grpc/internal/r0$h;->e()J
    ...
    new-array v1, v1, [Lio/grpc/internal/r0$h;
    ...
    invoke-virtual {v4}, Lio/grpc/internal/r0$h;->e()J
...
.method public static f(J)Lio/grpc/internal/r0$h;
    .locals 3
...
.method public static i(J)Lnb/j1;
    .locals 3

    invoke-static {p0, p1}, Lio/grpc/internal/r0$h;->f(J)Lio/grpc/internal/r0$h;

    move-result-object v0

    if-nez v0, :cond_0

    sget-object v0, Lio/grpc/internal/r0$h;->k:Lio/grpc/internal/r0$h;

    invoke-virtual {v0}, Lio/grpc/internal/r0$h;->g()Lnb/j1;
    ...
    invoke-virtual {v0}, Lnb/j1$b;->f()I
...
.method public e()J
    ...
    iget v0, p0, Lio/grpc/internal/r0$h;->g:I
...
.method public g()Lnb/j1;
    .locals 1

    iget-object v0, p0, Lio/grpc/internal/r0$h;->h:Lnb/j1;
