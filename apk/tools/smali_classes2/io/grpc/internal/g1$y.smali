...
# instance fields
.field final a:Lnb/r0$b;

.field final b:Lio/grpc/internal/g1$t;

.field final c:Lnb/j0;
...
# direct methods
.method constructor <init>(Lio/grpc/internal/g1;Lnb/r0$b;Lio/grpc/internal/g1$t;)V
    .locals 7
    ...
    invoke-virtual {p2}, Lnb/r0$b;->a()Ljava/util/List;
    ...
    invoke-virtual {p2}, Lnb/r0$b;->d()Lnb/r0$b$a;

    move-result-object p2

    invoke-virtual {p2, v0}, Lnb/r0$b$a;->d(Ljava/util/List;)Lnb/r0$b$a;

    move-result-object p2

    invoke-virtual {p2}, Lnb/r0$b$a;->b()Lnb/r0$b;

    move-result-object p2

    :cond_0
    iput-object p2, p0, Lio/grpc/internal/g1$y;->a:Lnb/r0$b;
    ...
    invoke-static {v0, p3}, Lnb/j0;->b(Ljava/lang/String;Ljava/lang/String;)Lnb/j0;

    move-result-object v2

    iput-object v2, p0, Lio/grpc/internal/g1$y;->c:Lnb/j0;
    ...
    invoke-direct/range {v1 .. v6}, Lio/grpc/internal/o;-><init>(Lnb/j0;IJLjava/lang/String;)V
...
.method private i(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lnb/x;->a()Ljava/util/List;

    move-result-object v3

    invoke-virtual {v1}, Lnb/x;->b()Lnb/a;

    move-result-object v1

    invoke-virtual {v1}, Lnb/a;->d()Lnb/a$b;

    move-result-object v1

    sget-object v4, Lnb/x;->d:Lnb/a$c;

    invoke-virtual {v1, v4}, Lnb/a$b;->c(Lnb/a$c;)Lnb/a$b;

    move-result-object v1

    invoke-virtual {v1}, Lnb/a$b;->a()Lnb/a;

    move-result-object v1

    invoke-direct {v2, v3, v1}, Lnb/x;-><init>(Ljava/util/List;Lnb/a;)V
...
.method public c()Lnb/a;
    ...
    iget-object v0, p0, Lio/grpc/internal/g1$y;->a:Lnb/r0$b;

    invoke-virtual {v0}, Lnb/r0$b;->b()Lnb/a;
...
.method public f()V
    ...
    iget-object v0, p0, Lio/grpc/internal/g1$y;->j:Lnb/n1$d;
    ...
    iput-object v0, p0, Lio/grpc/internal/g1$y;->j:Lnb/n1$d;
...
.method public g(Lnb/r0$j;)V
    ...
    iget-object v2, v0, Lio/grpc/internal/g1$y;->a:Lnb/r0$b;

    invoke-virtual {v2}, Lnb/r0$b;->a()Ljava/util/List;
    ...
    invoke-interface {v2}, Lio/grpc/internal/t;->m0()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v10

    iget-object v2, v0, Lio/grpc/internal/g1$y;->k:Lio/grpc/internal/g1;

    invoke-static {v2}, Lio/grpc/internal/g1;->j0(Lio/grpc/internal/g1;)Le5/o;

    move-result-object v11

    iget-object v2, v0, Lio/grpc/internal/g1$y;->k:Lio/grpc/internal/g1;

    iget-object v12, v2, Lio/grpc/internal/g1;->s:Lnb/n1;

    new-instance v13, Lio/grpc/internal/g1$y$a;

    move-object/from16 v2, p1

    invoke-direct {v13, v0, v2}, Lio/grpc/internal/g1$y$a;-><init>(Lio/grpc/internal/g1$y;Lnb/r0$j;)V

    iget-object v2, v0, Lio/grpc/internal/g1$y;->k:Lio/grpc/internal/g1;

    invoke-static {v2}, Lio/grpc/internal/g1;->f0(Lio/grpc/internal/g1;)Lnb/d0;
    ...
    iget-object v3, v0, Lio/grpc/internal/g1$y;->c:Lnb/j0;
    ...
    invoke-direct/range {v4 .. v18}, Lio/grpc/internal/y0;-><init>(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;Lio/grpc/internal/k$a;Lio/grpc/internal/t;Ljava/util/concurrent/ScheduledExecutorService;Le5/o;Lnb/n1;Lio/grpc/internal/y0$j;Lnb/d0;Lio/grpc/internal/m;Lio/grpc/internal/o;Lnb/j0;Lnb/f;)V
    ...
    new-instance v3, Lnb/e0$a;

    invoke-direct {v3}, Lnb/e0$a;-><init>()V

    const-string v4, "Child Subchannel started"

    invoke-virtual {v3, v4}, Lnb/e0$a;->b(Ljava/lang/String;)Lnb/e0$a;

    move-result-object v3

    sget-object v4, Lnb/e0$b;->h:Lnb/e0$b;

    invoke-virtual {v3, v4}, Lnb/e0$a;->c(Lnb/e0$b;)Lnb/e0$a;
    ...
    invoke-virtual {v3, v4, v5}, Lnb/e0$a;->e(J)Lnb/e0$a;

    move-result-object v3

    invoke-virtual {v3, v1}, Lnb/e0$a;->d(Lnb/p0;)Lnb/e0$a;

    move-result-object v3

    invoke-virtual {v3}, Lnb/e0$a;->a()Lnb/e0;

    move-result-object v3

    invoke-virtual {v2, v3}, Lio/grpc/internal/o;->e(Lnb/e0;)V
    ...
    invoke-virtual {v2, v1}, Lnb/d0;->e(Lnb/i0;)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/grpc/internal/g1$y;->c:Lnb/j0;

    invoke-virtual {v0}, Lnb/j0;->toString()Ljava/lang/String;
