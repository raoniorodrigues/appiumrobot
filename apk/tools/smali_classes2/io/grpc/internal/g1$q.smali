...
.method constructor <init>(Lio/grpc/internal/p1;)V
    ...
    iput-object p1, p0, Lio/grpc/internal/g1$q;->g:Lio/grpc/internal/p1;
...
.method declared-synchronized a()Ljava/util/concurrent/Executor;
    ...
    :try_start_0
    iget-object v0, p0, Lio/grpc/internal/g1$q;->h:Ljava/util/concurrent/Executor;

    if-nez v0, :cond_0

    iget-object v0, p0, Lio/grpc/internal/g1$q;->g:Lio/grpc/internal/p1;
    ...
    iget-object v2, p0, Lio/grpc/internal/g1$q;->h:Ljava/util/concurrent/Executor;

    invoke-static {v0, v1, v2}, Le5/k;->p(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Ljava/util/concurrent/Executor;

    iput-object v0, p0, Lio/grpc/internal/g1$q;->h:Ljava/util/concurrent/Executor;
...
.method declared-synchronized b()V
    ...
    iget-object v1, p0, Lio/grpc/internal/g1$q;->g:Lio/grpc/internal/p1;
