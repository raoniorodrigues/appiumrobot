...
.field private j:Lnb/j1;

.field private k:Lnb/r0$i;

.field private l:J


# direct methods
.method constructor <init>(Ljava/util/concurrent/Executor;Lnb/n1;)V
    .locals 2
    ...
    invoke-static {v0, v1}, Lnb/j0;->a(Ljava/lang/Class;Ljava/lang/String;)Lnb/j0;

    move-result-object v0

    iput-object v0, p0, Lio/grpc/internal/a0;->a:Lnb/j0;
    ...
    iput-object p2, p0, Lio/grpc/internal/a0;->d:Lnb/n1;
...
.method static synthetic f(Lio/grpc/internal/a0;)Lnb/j1;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/a0;->j:Lnb/j1;
...
.method static synthetic n(Lio/grpc/internal/a0;)Lnb/n1;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/a0;->d:Lnb/n1;

    return-object p0
.end method

.method private o(Lnb/r0$f;[Lnb/k;)Lio/grpc/internal/a0$e;
    .locals 2
    ...
    invoke-direct {v0, p0, p1, p2, v1}, Lio/grpc/internal/a0$e;-><init>(Lio/grpc/internal/a0;Lnb/r0$f;[Lnb/k;Lio/grpc/internal/a0$a;)V
    ...
    iget-object p1, p0, Lio/grpc/internal/a0;->d:Lnb/n1;

    iget-object p2, p0, Lio/grpc/internal/a0;->e:Ljava/lang/Runnable;

    invoke-virtual {p1, p2}, Lnb/n1;->b(Ljava/lang/Runnable;)V
...
# virtual methods
.method public final b(Lnb/j1;)V
    .locals 6

    invoke-virtual {p0, p1}, Lio/grpc/internal/a0;->e(Lnb/j1;)V
    ...
    sget-object v4, Lio/grpc/internal/r$a;->h:Lio/grpc/internal/r$a;

    invoke-static {v1}, Lio/grpc/internal/a0$e;->y(Lio/grpc/internal/a0$e;)[Lnb/k;

    move-result-object v5

    invoke-direct {v3, p1, v4, v5}, Lio/grpc/internal/f0;-><init>(Lnb/j1;Lio/grpc/internal/r$a;[Lnb/k;)V
    ...
    invoke-virtual {p1, v2}, Lnb/n1;->execute(Ljava/lang/Runnable;)V
...
.method public final c(Lio/grpc/internal/k1$a;)Ljava/lang/Runnable;
    .locals 1
...
.method public final d(Lnb/z0;Lnb/y0;Lnb/c;[Lnb/k;)Lio/grpc/internal/q;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p3}, Lio/grpc/internal/t1;-><init>(Lnb/z0;Lnb/y0;Lnb/c;)V
    ...
    :try_start_1
    iget-object v3, p0, Lio/grpc/internal/a0;->j:Lnb/j1;

    if-eqz v3, :cond_0

    new-instance p1, Lio/grpc/internal/f0;

    iget-object p3, p0, Lio/grpc/internal/a0;->j:Lnb/j1;

    invoke-direct {p1, p3, p4}, Lio/grpc/internal/f0;-><init>(Lnb/j1;[Lnb/k;)V
    ...
    :goto_2
    iget-object p2, p0, Lio/grpc/internal/a0;->d:Lnb/n1;

    invoke-virtual {p2}, Lnb/n1;->a()V

    return-object p1

    :cond_0
    :try_start_2
    iget-object v3, p0, Lio/grpc/internal/a0;->k:Lnb/r0$i;

    if-nez v3, :cond_1

    invoke-direct {p0, v0, p4}, Lio/grpc/internal/a0;->o(Lnb/r0$f;[Lnb/k;)Lio/grpc/internal/a0$e;
    ...
    :try_start_3
    invoke-virtual {v3, v0}, Lnb/r0$i;->a(Lnb/r0$f;)Lnb/r0$e;

    move-result-object p1

    invoke-virtual {p3}, Lnb/c;->j()Z

    move-result p2

    invoke-static {p1, p2}, Lio/grpc/internal/r0;->j(Lnb/r0$e;Z)Lio/grpc/internal/s;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-virtual {v0}, Lnb/r0$f;->c()Lnb/z0;

    move-result-object p2

    invoke-virtual {v0}, Lnb/r0$f;->b()Lnb/y0;

    move-result-object p3

    invoke-virtual {v0}, Lnb/r0$f;->a()Lnb/c;

    move-result-object v0

    invoke-interface {p1, p2, p3, v0, p4}, Lio/grpc/internal/s;->d(Lnb/z0;Lnb/y0;Lnb/c;[Lnb/k;)Lio/grpc/internal/q;
...
.method public final e(Lnb/j1;)V
    .locals 3
    ...
    :try_start_0
    iget-object v1, p0, Lio/grpc/internal/a0;->j:Lnb/j1;
    ...
    :cond_0
    iput-object p1, p0, Lio/grpc/internal/a0;->j:Lnb/j1;

    iget-object v1, p0, Lio/grpc/internal/a0;->d:Lnb/n1;

    new-instance v2, Lio/grpc/internal/a0$d;

    invoke-direct {v2, p0, p1}, Lio/grpc/internal/a0$d;-><init>(Lio/grpc/internal/a0;Lnb/j1;)V

    invoke-virtual {v1, v2}, Lnb/n1;->b(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v1, p1}, Lnb/n1;->b(Ljava/lang/Runnable;)V
...
.method public g()Lnb/j0;
    ...
    iget-object v0, p0, Lio/grpc/internal/a0;->a:Lnb/j0;
...
.method final r(Lnb/r0$i;)V
    ...
    :try_start_0
    iput-object p1, p0, Lio/grpc/internal/a0;->k:Lnb/r0$i;
    ...
    invoke-static {v2}, Lio/grpc/internal/a0$e;->z(Lio/grpc/internal/a0$e;)Lnb/r0$f;

    move-result-object v3

    invoke-virtual {p1, v3}, Lnb/r0$i;->a(Lnb/r0$f;)Lnb/r0$e;
    ...
    invoke-virtual {v4}, Lnb/r0$f;->a()Lnb/c;

    move-result-object v4

    invoke-virtual {v4}, Lnb/c;->j()Z

    move-result v5

    invoke-static {v3, v5}, Lio/grpc/internal/r0;->j(Lnb/r0$e;Z)Lio/grpc/internal/s;
    ...
    invoke-virtual {v4}, Lnb/c;->e()Ljava/util/concurrent/Executor;
    ...
    iget-object v0, p0, Lio/grpc/internal/a0;->d:Lnb/n1;

    iget-object v1, p0, Lio/grpc/internal/a0;->f:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Lnb/n1;->b(Ljava/lang/Runnable;)V

    iget-object v0, p0, Lio/grpc/internal/a0;->j:Lnb/j1;
    ...
    invoke-virtual {v1, v0}, Lnb/n1;->b(Ljava/lang/Runnable;)V
