...
.field private static final k:Lnb/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnb/g<",
            "Ljava/lang/Object;",
...
.field private final c:Lnb/r;

.field private volatile d:Z

.field private e:Lnb/g$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lnb/g$a<",
            "TRespT;>;"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/grpc/internal/z;->k:Lnb/g;

    return-void
.end method

.method protected constructor <init>(Ljava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;Lnb/t;)V
    .locals 1
    ...
    iput-object p1, p0, Lio/grpc/internal/z;->c:Lnb/r;

    invoke-direct {p0, p2, p3}, Lio/grpc/internal/z;->o(Ljava/util/concurrent/ScheduledExecutorService;Lnb/t;)Ljava/util/concurrent/ScheduledFuture;
...
.method static synthetic f(Lio/grpc/internal/z;Lnb/j1;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/grpc/internal/z;->k(Lnb/j1;Z)V
...
.method static synthetic h(Lio/grpc/internal/z;)Lnb/g;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/z;->f:Lnb/g;

    return-object p0
.end method

.method static synthetic i(Lio/grpc/internal/z;)Lnb/r;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/z;->c:Lnb/r;

    return-object p0
.end method

.method private k(Lnb/j1;Z)V
    .locals 2

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lio/grpc/internal/z;->f:Lnb/g;

    if-nez v0, :cond_0

    sget-object p2, Lio/grpc/internal/z;->k:Lnb/g;

    invoke-direct {p0, p2}, Lio/grpc/internal/z;->q(Lnb/g;)V

    const/4 p2, 0x0

    iget-object v0, p0, Lio/grpc/internal/z;->e:Lnb/g$a;

    iput-object p1, p0, Lio/grpc/internal/z;->g:Lnb/j1;
    ...
    invoke-direct {p2, p0, p1}, Lio/grpc/internal/z$e;-><init>(Lio/grpc/internal/z;Lnb/j1;)V
    ...
    invoke-direct {v1, p0, v0, p1}, Lio/grpc/internal/z$j;-><init>(Lio/grpc/internal/z;Lnb/g$a;Lnb/j1;)V
...
.method private n(Lnb/t;Lnb/t;)Z
    .locals 0
    ...
    :cond_1
    invoke-virtual {p1, p2}, Lnb/t;->j(Lnb/t;)Z
...
.method private o(Ljava/util/concurrent/ScheduledExecutorService;Lnb/t;)Ljava/util/concurrent/ScheduledFuture;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lio/grpc/internal/z;->c:Lnb/r;

    invoke-virtual {v0}, Lnb/r;->g()Lnb/t;
    ...
    invoke-virtual {p2, v1}, Lnb/t;->r(Ljava/util/concurrent/TimeUnit;)J
    ...
    invoke-virtual {v0, v5}, Lnb/t;->r(Ljava/util/concurrent/TimeUnit;)J
    ...
    :cond_2
    invoke-virtual {p2, v5}, Lnb/t;->r(Ljava/util/concurrent/TimeUnit;)J
    ...
    invoke-direct {p0, v0, p2}, Lio/grpc/internal/z;->n(Lnb/t;Lnb/t;)Z
...
.method private q(Lnb/g;)V
    ...
    invoke-static {v2, v3, v0}, Le5/k;->w(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_1
    iput-object p1, p0, Lio/grpc/internal/z;->f:Lnb/g;
...
.method public final e(Lnb/g$a;Lnb/y0;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lio/grpc/internal/z;->e:Lnb/g$a;

    iget-object v0, p0, Lio/grpc/internal/z;->g:Lnb/j1;
    ...
    invoke-direct {v2, p1}, Lio/grpc/internal/z$k;-><init>(Lnb/g$a;)V
    ...
    invoke-direct {v1, p0, p1, v0}, Lio/grpc/internal/z$j;-><init>(Lio/grpc/internal/z;Lnb/g$a;Lnb/j1;)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lio/grpc/internal/z$d;-><init>(Lio/grpc/internal/z;Lnb/g$a;Lnb/y0;)V
...
.method public final p(Lnb/g;)Ljava/lang/Runnable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1}, Lio/grpc/internal/z;->q(Lnb/g;)V
    ...
    invoke-direct {p1, p0, v0}, Lio/grpc/internal/z$a;-><init>(Lio/grpc/internal/z;Lnb/r;)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/grpc/internal/z;->f:Lnb/g;
