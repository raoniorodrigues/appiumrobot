...
# instance fields
.field final synthetic g:Lha/j;


# direct methods
.method constructor <init>(Lha/j;)V
    .locals 0

    iput-object p1, p0, Lha/j$a;->g:Lha/j;
...
.method public a(Lia/i;Lia/j$d;)V
    ...
    iget-object v1, p0, Lha/j$a;->g:Lha/j;

    invoke-static {v1}, Lha/j;->a(Lha/j;)Lha/j$h;
    ...
    :pswitch_0
    iget-object p1, p0, Lha/j$a;->g:Lha/j;

    invoke-static {p1}, Lha/j;->a(Lha/j;)Lha/j$h;

    move-result-object p1

    invoke-interface {p1}, Lha/j$h;->q()Z
    ...
    invoke-interface {v1, p1}, Lha/j$h;->i(Ljava/lang/String;)V

    :cond_2
    :goto_1
    invoke-interface {p2, v3}, Lia/j$d;->a(Ljava/lang/Object;)V
    ...
    :try_start_2
    invoke-static {p1}, Lha/j$e;->c(Ljava/lang/String;)Lha/j$e;
    ...
    :goto_2
    iget-object v2, p0, Lha/j$a;->g:Lha/j;

    invoke-static {v2}, Lha/j;->a(Lha/j;)Lha/j$h;

    move-result-object v2

    invoke-interface {v2, p1}, Lha/j$h;->g(Lha/j$e;)Ljava/lang/CharSequence;
    ...
    invoke-interface {p2, v2}, Lia/j$d;->a(Ljava/lang/Object;)V
    ...
    invoke-interface {p1}, Lha/j$h;->b()V
    ...
    invoke-interface {v1, p1}, Lha/j$h;->f(Z)V
    :try_end_3
    ...
    invoke-static {v1, p1}, Lha/j;->f(Lha/j;Lorg/json/JSONObject;)Lha/j$j;
    ...
    invoke-interface {v1, p1}, Lha/j$h;->r(Lha/j$j;)V
    ...
    invoke-interface {p1}, Lha/j$h;->o()V
    ...
    invoke-interface {p1}, Lha/j$h;->m()V
    :try_end_5
    ...
    invoke-static {v1, p1}, Lha/j;->e(Lha/j;Ljava/lang/String;)Lha/j$k;
    ...
    invoke-interface {v1, p1}, Lha/j$h;->l(Lha/j$k;)V
    ...
    invoke-static {v1, p1}, Lha/j;->d(Lha/j;Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-interface {v1, p1}, Lha/j$h;->h(Ljava/util/List;)V
    ...
    invoke-static {v1, p1}, Lha/j;->c(Lha/j;Lorg/json/JSONObject;)Lha/j$c;
    ...
    invoke-interface {v1, p1}, Lha/j$h;->n(Lha/j$c;)V
    ...
    invoke-static {v1, p1}, Lha/j;->b(Lha/j;Lorg/json/JSONArray;)I
    ...
    invoke-interface {v1, p1}, Lha/j$h;->p(I)V
    ...
    invoke-static {p1}, Lha/j$g;->c(Ljava/lang/String;)Lha/j$g;
    ...
    invoke-interface {v1, p1}, Lha/j$h;->k(Lha/j$g;)V
    ...
    invoke-static {p1}, Lha/j$i;->c(Ljava/lang/String;)Lha/j$i;
    ...
    invoke-interface {v1, p1}, Lha/j$h;->j(Lha/j$i;)V
